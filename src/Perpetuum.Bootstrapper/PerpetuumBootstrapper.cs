...
namespace Perpetuum.Bootstrapper
{
    ...
    public class PerpetuumBootstrapper
    {
        ...
        public bool TryInitUpnp(out bool success)
        {
            ...
            Logger.Error("[UPNP] Automatic port mapping is unavailable in the cross-platform server. Configure port forwarding explicitly or disable EnableUpnp.");
            return true;
        }
        ...
        private void InitRelayManager()
        {
            ...
            _ = _builder.RegisterType<ExtensionTrainingActionService>().As<IExtensionTrainingActionService>();
            ...
            _ = _builder.RegisterType<MissionActionService>().As<IMissionActionService>();
            ...
            _ = _builder.RegisterType<DatabaseAutonomousPopulationSampleStore>()
                .As<IAutonomousPopulationSampleStore>()
                .SingleInstance();
            _ = _builder.RegisterType<AutonomousPopulationTelemetry>()
                .As<IAutonomousPopulationTelemetry>()
                .SingleInstance();
